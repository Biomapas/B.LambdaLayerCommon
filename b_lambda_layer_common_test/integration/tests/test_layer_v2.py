...
def test_RESOURCE_lambda_layer_v2_WITH_deployed_lambda_function_3_EXPECT_execution_successful():
    """
    ...
    assert data['Boto3Version'] is not None, data
    assert data['BotocoreVersion'] is not None, data
